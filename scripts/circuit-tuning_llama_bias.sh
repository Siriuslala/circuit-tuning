...
CKPT_NAME="fix_gate-Circuit-$MODEL-$TASK-epochs_$NUM_EPOCHS-bsz_$BSZ-ori_bsz_$BATCH_SIZE-lr_$LR-Opt_$OPTIMIZER_NAME-top_n_$TOP_N-topn_start_$TOPN_START-warmup_$TOPN_WARMUP-$TOPN_TYPE-reg_${REGULARIZATION_BETA}"
...
device_id=6
torchrun --nnodes 1 --nproc_per_node $N_DEVICES --master_port 11444 circuit_tuning_llama.py \
