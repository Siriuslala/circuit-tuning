...
def freeze_bias(model):
    keys = ["b_Q", "b_K", "b_V", "b_O"]
...
if __name__ == '__main__':
    ...
    if args.task == "sv":
        train_dataset = SVDataset(model.tokenizer, split="train")
        dev_dataset = SVDataset(model.tokenizer, split="dev")
    elif args.task == "bias":
