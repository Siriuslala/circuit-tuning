...
def test_svd_ability(model, tokenizer, device, save_path):
    ...
    prompt_list = []
    sv_test_path = root_dir / "data/sv_test/sv_test.txt"
...
if __name__ == "__main__":
    ...
    def test_sv():
        ...
        ckpt_path = work_dir / "checkpoints-new/gpt2-small-sv-epochs_3-bsz_16-lr_1e-3-Opt_{SGD}-warm_up_100-top_n_30000-threshold_0-random_ratio_0-ablation_{mean}-loss_weighted(p_1)/model-steps_1499_epoch_3.pt"
