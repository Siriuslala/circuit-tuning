...
python squad.py \
    ...
    --ckpt_path "/raid_sdd/lyy/Interpretability/lyy/circuit-tuning/checkpoints-reading/llama3.2-1b-it-reading-epochs_1-bsz_16-lr_3e-05-Opt_SGD-lora_r32_alpha64-precision_bf16-max_train_step_500/peft_1" \
    --device 'cuda:3' \
    --output_dir "llama-3.2-1b-it-reading-peft" \
