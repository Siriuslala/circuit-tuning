...
if __name__ == "__main__":
    ...
    def draw_graph_for_every_log_step():
        ...
        log_path = work_dir / "checkpoints-new/gpt2-small-sv-epochs_3-bsz_16-lr_1e-3-Opt_SGD-warm_up_100-top_n_1000-threshold_0-metric-logit_diff-random_ratio_0-randn_0-ablation_mean-loss_weighted_p_1-prune_method_top_nodes/log.jsonl"
        topn=1000
        select = 35
        graph_dir = work_dir / f"figures/eap_graph/eap_graph_svd_topn_{topn}_select_{select}"
    ...
    def analyze_hebbian_learning_sv_svd():
        ...
        sv_path = work_dir / "figures/eap_graph/sv_topn_50_sel_35_edge_info.jsonl"
        with jsonlines.open(sv_path, "r") as f:
            lines = [line for line in f]
        sv_edges = lines[0]["edges"]
        
        edge_info_path = work_dir / "figures/eap_graph/eap_graph_svd_topn_50_select_35/edge_scores.jsonl"
