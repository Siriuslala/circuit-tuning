...
def get_huggingface_dataset():
    ...
    snapshot_download(repo_id="NeelNanda/pile-10k", 
                      repo_type="dataset",
                      cache_dir=None,
...
def process_data_pile():
    data_path = hf_dir / "datasets--NeelNanda--pile-10k/snapshots/127bfedcd5047750df5ccf3a12979a47bfa0bafa/data/train-00000-of-00001-4746b8785c874cc7.parquet"
    df = pd.read_parquet(data_path)
    dataset = df.to_dict(orient='records')
    
    raw_pile_data_path = root_dir / "data/sv_pile_10k.jsonl"
...
def get_subj():
    nlp = spacy.load("en_core_web_sm")
    data_path = root_dir / "data/sv_dataset/test_3000_single_verb.jsonl"
    tgt_path = root_dir / "data/sv_dataset/test_3000_single_verb_new.jsonl"
...
def format_subj(tokenizer):
    ...
    data_path = root_dir / "data/sv_dataset/test_3000_single_verb_with_subj.jsonl"
    tgt_path = root_dir / "data/sv_dataset/test_3000_single_verb_with_subj_formatted.jsonl"
    with jsonlines.open(data_path, "r") as f, jsonlines.open(tgt_path, "w") as f1:
        for line in f:
            sentence = line["clean_text"]
...
if __name__ == '__main__':
    ...
    # src_path = root_dir / "data/sv_pile_10k.jsonl"
    # tgt_path = root_dir / "data/sv_pile_10k_annotated.jsonl"
    # annotate_data_pile(src_path=src_path, tgt_path=tgt_path)
    
    # src_path = root_dir / "data/sv_pile_10k_annotated.jsonl"
    # tgt_path = root_dir / "data/sv_pile_10k_formatted.jsonl"
    ...
    # src_path = root_dir / "data/sv_pile_10k_formatted.jsonl"
    # tgt_dir = root_dir / "data/sv_dataset"
    # data_num = 30000 
    # ratio = [8, 1, 1]
