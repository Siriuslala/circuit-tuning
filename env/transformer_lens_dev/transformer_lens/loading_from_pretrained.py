...
def get_pretrained_state_dict(
    ...
    **kwargs: Any,
    ...
    if (
        ...
        split_params = kwargs.get("split_params", False)
        ...
        if cfg.original_architecture == "GPT2LMHeadModel":
            ...
            state_dict = convert_llama_weights_split(hf_model, cfg) if split_params else convert_llama_weights(hf_model, cfg)
